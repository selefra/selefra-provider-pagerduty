# Selefra Provider Pagerduty

Use this repo as a raw reference to **tables and schema** for Pagerduty usage. [Here's](https://github.com/selefra/selefra-provider-pagerduty/blob/main/docs/tables/pagerduty.md) a summary of full coverage. 
